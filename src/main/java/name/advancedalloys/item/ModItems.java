...
public class ModItems {
    ...
    public static final Item BETRAYER = registerItem("betrayer", new ModBetrayerItem(ModToolMaterials.GUARDIAN,2,-2.9f,new FabricItemSettings().rarity(Rarity.EPIC).maxCount(1)), ModItemGroup.SPECIAL);
    ...
    public static final Item COPPER_NETHERITE_HELMET = registerItem("copper_netherite_helmet", new ProjectileImmuneArmorItem(ModArmorMaterials.COPPER_NETHERITE, ArmorItem.Type.HELMET,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)), ModItemGroup.ARMOR);
    public static final Item COPPER_NETHERITE_CHESTPLATE = registerItem("copper_netherite_chestplate", new ProjectileImmuneArmorItem(ModArmorMaterials.COPPER_NETHERITE, ArmorItem.Type.CHESTPLATE,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)), ModItemGroup.ARMOR);
    public static final Item COPPER_NETHERITE_LEGGINGS = registerItem("copper_netherite_leggings", new ProjectileImmuneArmorItem(ModArmorMaterials.COPPER_NETHERITE, ArmorItem.Type.LEGGINGS,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)), ModItemGroup.ARMOR);
    public static final Item COPPER_NETHERITE_BOOTS = registerItem("copper_netherite_boots", new ProjectileImmuneArmorItem(ModArmorMaterials.COPPER_NETHERITE, ArmorItem.Type.BOOTS,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)), ModItemGroup.ARMOR);
