...
public class AlloyBlasterScreen extends HandledScreen<AlloyBlasterScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(AdvancedAlloys.MOD_ID, "textures/gui/alloy_blaster_gui.png");
    public AlloyBlasterScreen(AlloyBlasterScreenHandler handler, PlayerInventory inventory, Text title) {
