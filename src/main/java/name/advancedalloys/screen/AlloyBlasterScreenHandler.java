...
import name.advancedalloys.screen.slot.ModFuelSlot;
import name.advancedalloys.screen.slot.ModResultSlot;
...
public class AlloyBlasterScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;

    public AlloyBlasterScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(4), new ArrayPropertyDelegate(4));
    }

    public AlloyBlasterScreenHandler(int syncId, PlayerInventory playerInventory,
                                      Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.ALLOY_BLASTER_SCREEN_HANDLER, syncId);
